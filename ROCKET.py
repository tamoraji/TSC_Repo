...
from classifiers import ROCKET_module
...
for dataset in datasets:
    ...
    #Run The ROCKET Module
    ROCKET_module.ROCKET(results_path, Dataset_name, Dataset, Labels, nb_folds=n_folds, n_kernel=1000)
