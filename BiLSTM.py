...
# "CWRU_12k_DE_univar",#Starting to work on CWRU_12k_DE_univar_Dataset at 2023-06-20 09:45:34
# "CWRU_12k_DE_multivar",
# "CWRU_12k_FE_univar",#Starting to work on CWRU_12k_FE_univar_Dataset at 2023-06-20 18:23:48
...
for dataset in datasets:
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(Dataset)):
        ...
        ## Create Classification module
        from dl4tsc.classifiers import BiLSTM
        classifier = BiLSTM.Classifier_BiLSTM(output_directory=results_path, input_shape=input_shape,
    ...
    with open(f'{results_path}/dataset_{Dataset_name}_BiLSTM_.txt', 'w') as f:
