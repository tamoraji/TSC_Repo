...
# "Gas_sensors_home_activity",#error on n_bins
# "PHM2022_Multivar",
# "PHM2022_Univar_PIN",
# "PHM2022_Univar_PO",
# "PHM2022_Univar_PDIN",
...
from classifiers import BOSSVS_module
...
for dataset in datasets:
    ...
    classes = min(5,nb_classes)

    #Run The BOSSVS Module
    BOSSVS_module.BOSSVS(results_path, Dataset_name, Dataset, Labels, nb_folds=n_folds,
                         word_size=4, 
                         n_bins=classes, 
                         window_size=20)
