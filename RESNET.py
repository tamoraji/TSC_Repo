...
for dataset in datasets:
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(Dataset)):
        ...
        classifier = resnet.Classifier_RESNET(output_directory=results_path, input_shape=input_shape,
        ...
        with open(f'{results_path}/dataset_{Dataset_name}_RESNET_fold_{fold+1}.txt', 'w') as f:
    ...
    with open(f'{results_path}/dataset_{Dataset_name}_RESNET.txt', 'w') as f:
