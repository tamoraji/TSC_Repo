...
class Classifier_stackedLSTM:

    def __init__(self, output_directory, input_shape, nb_classes, verbose=True,build=True, lr = 0.001, batch_size=64, epoch = 200):
    ...
    def build_model(self, input_shape, nb_classes,lr):
        ...
        lstm2 = keras.layers.LSTM(64, return_sequences=True)(dropout1)
        dropout2 = keras.layers.Dropout(0.3)(lstm2)

        lstm3 = keras.layers.LSTM(32)(dropout2)
        dropout3 = keras.layers.Dropout(0.3)(lstm3)


        output_layer = keras.layers.Dense(units=nb_classes,activation='softmax')(dropout3)
