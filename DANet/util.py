...
def compute_F1_score(trueY, predY):
    oriF1 = f1_score(trueY.cpu().data.numpy(), predY.cpu().data.numpy(), average='weighted')
    precision = precision_score(trueY.cpu().data.numpy(), predY.cpu().data.numpy(), average='weighted')
    recall = recall_score(trueY.cpu().data.numpy(), predY.cpu().data.numpy(), average='weighted')
