...
for dataset in datasets:
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(Dataset)):
        ...
        from dl4tsc.classifiers import GASFCNN
        classifier = GASFCNN.Classifier_GASFCNN(output_directory=results_path, input_shape=input_shape,
                                        nb_classes=nb_classes, verbose=True,
                                        lr=0.0001, batch_size=32, epoch = 100)
        ...
        with open(f'{results_path}/dataset_{Dataset_name}_GASFCNN_fold_{fold+1}.txt', 'w') as f:
    ...
    with open(f'{results_path}/dataset_{Dataset_name}_GASFCNN_.txt', 'w') as f:
